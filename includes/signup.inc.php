    ...
    if (isset($_POST['submit-btn'])) {
        ...
        if (empty($fullname) || empty($user_type) || empty($username) || empty($email) || empty($user_pwd)) {
            ...
            if (!preg_match("/^[a-zA-Z]*$/", $fullname)) {
                ...
                //Check if usertype is taken
                $sql = "SELECT * FROM jj_inv_user WHERE user_type='$user_type'";
                ...
                exit();
                    ...
                    $sql = "SELECT * FROM jj_inv_user WHERE username='$username'";
                    $result = mysqli_query($conn, $sql);
                    $resultCheck = mysqli_num_rows($result);
                    ...
                    exit();
                        ...
                        exit();
                            ...
                            $sql = "INSERT INTO jj_inv_user (fullname, user_type, username, email, password) VALUES('$fullname', '$user_type', '$username', '$email', '$hashPass');";
